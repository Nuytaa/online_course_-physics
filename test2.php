...
$sql = "SELECT * FROM variant_otvetov WHERE id_test=8";
$sql1 = "SELECT otvet1, otvet2, otvet3, otvet4 FROM variant_otvetov WHERE id_test=8";
...
$info = [];
  if($query = $connect -> query("SELECT otvet1, otvet2, otvet3, otvet4  FROM variant_otvetov WHERE id_test=8")) {
...
$sql2 = "SELECT * FROM variant_otvetov WHERE id_test=9";
$sql3 = "SELECT otvet1, otvet2, otvet3, otvet4 FROM variant_otvetov WHERE id_test=9";
...
$info2 = [];
  if($query = $connect -> query("SELECT otvet1, otvet2, otvet3, otvet4  FROM variant_otvetov WHERE id_test=9")) {
...
$sql4 = "SELECT * FROM variant_otvetov WHERE id_test=10";
$sql5 = "SELECT otvet1, otvet2, otvet3, otvet4 FROM variant_otvetov WHERE id_test=10";
...
$info3 = [];
  if($query = $connect -> query("SELECT otvet1, otvet2, otvet3, otvet4  FROM variant_otvetov WHERE id_test=10")) {
...
$sql6= "SELECT * FROM variant_otvetov WHERE id_test=11";
$sql7 = "SELECT otvet1, otvet2, otvet3, otvet4 FROM variant_otvetov WHERE id_test=11";
...
$info4 = [];
  if($query = $connect -> query("SELECT otvet1, otvet2, otvet3, otvet4  FROM variant_otvetov WHERE id_test=11")) {
...
<h1>Тест по теме "Закон Гука"</h1>
 
<section class="main">
 
<form name="quiz" action="javascript:check();" class="quizform" method="POST">
...
<div class="quizsection">
    ...
    <div class="answer">
        <input type="radio" value="1" name="q1" id="value1" checked="checked">
    ...
    <div class="answer">
        <input type="radio" value="0" name="q1" id="value3" checked="checked">
...
<div class="quizsection">
    ...
    <div class="answer">
        <input type="radio" value="1" name="q2" id="value2" checked="checked">
...
<div class="quizsection">
    ...
    <div class="answer">
        <input name="q3" value="1" id="value1" type="radio" checked="checked" /> 
...
<div class="quizsection">
    ...
    <div class="answer">
        <input name="q4" value="1" id="value1" type="radio" checked="checked" /> 
